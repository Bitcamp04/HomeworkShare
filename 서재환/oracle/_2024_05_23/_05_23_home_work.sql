...
FROM PROFESSOR 
WHERE HIREDATE BETWEEN TO_DATE('19910101','YYYYMMDD') AND ADD_MONTHS(TO_DATE('19910101','YYYYMMDD'),48);
...
TRUNC(MOD(MONTHS_BETWEEN(SYSDATE,HDATE),TRUNC(MONTHS_BETWEEN(SYSDATE,HDATE),0))*31,0)  AS "일"
FROM EMP
